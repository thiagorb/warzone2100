...
void startVideoOptionsMenu()
{
	...
	// Fullscreen/windowed
	grid->place({0}, {0}, addMargin(makeTextButton(FRONTEND_WINDOWMODE, videoOptionsWindowModeLabel(), WBUT_SECONDARY)));
	grid->place({1, 1, false}, {0}, addMargin(makeTextButton(FRONTEND_WINDOWMODE_R, videoOptionsWindowModeString(), WBUT_SECONDARY)));
	...
	grid->place({0}, {1}, resolutionReadonlyLabelContainer);
	grid->place({1, 1, false}, {1}, resolutionReadonlyValueContainer);
	...
	grid->place({0}, {1}, resolutionDropdownLabelContainer);
	grid->place({1, 1, false}, {1}, addMargin(makeResolutionDropdown()));

	// Texture size
	grid->place({0}, {2}, addMargin(makeTextButton(FRONTEND_TEXTURESZ, _("Texture size"), WBUT_SECONDARY)));
	grid->place({1, 1, false}, {2}, addMargin(makeTextButton(FRONTEND_TEXTURESZ_R, videoOptionsTextureSizeString(), WBUT_SECONDARY)));

	// Vsync
	grid->place({0}, {3}, addMargin(makeTextButton(FRONTEND_VSYNC, _("Vertical sync"), WBUT_SECONDARY)));
	grid->place({1, 1, false}, {3}, addMargin(makeTextButton(FRONTEND_VSYNC_R, videoOptionsVsyncString(), WBUT_SECONDARY)));

	// Antialiasing
	grid->place({0}, {4}, addMargin(makeTextButton(FRONTEND_FSAA, _("Antialiasing*"), WBUT_SECONDARY)));
	grid->place({1, 1, false}, {4}, addMargin(makeTextButton(FRONTEND_FSAA_R, videoOptionsAntialiasingString(), WBUT_SECONDARY)));
	...
	if (showDisplayScale)
	{
		grid->place({0}, {5}, addMargin(makeTextButton(FRONTEND_DISPLAYSCALE, videoOptionsDisplayScaleLabel(), WBUT_SECONDARY)));
		grid->place({1, 1, false}, {5}, addMargin(makeTextButton(FRONTEND_DISPLAYSCALE_R, videoOptionsDisplayScaleString(), WBUT_SECONDARY)));
	}
